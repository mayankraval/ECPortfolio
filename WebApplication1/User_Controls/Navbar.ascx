    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li id="projects" runat="server"><a href="Projects.aspx"><i class="fa fa-envira fa-lg"></i> Projects</a></li>
                <li id="services" runat="server"><a href="Services.aspx"><i class="fa fa-server fa-lg"></i> Services</a></li>
